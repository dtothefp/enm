...
module.exports = function(grunt) {
	grunt.initConfig({
		...
		sass: {
			options: {
				includePaths: ['<%= app %>/bower_components/foundation/scss', require('node-bourbon').includePaths, '<%= app %>/bower_components/saffron/saffron'],
	...
	grunt.registerTask('compile-sass', ['newer:sass']);
